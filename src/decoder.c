...
struct InstructionInformation baseInstructions[0x100] = {
    ...
    {"JR NC, 0x%04X", 1, TRUE},
    {"LD SP, 0x%04X", 2, FALSE},
    {"LDD (HL), A", 0, FALSE},
    {"INC SP", 0, FALSE},
    {"INC (HL)", 0, FALSE},
    {"DEC (HL)", 0, FALSE},
    {"LD (HL), 0x%02X", 1, FALSE},
    {"SCF", 0, FALSE},
    {"JR C, 0x%04X", 1, TRUE},
    {"ADD HL, SP", 0, FALSE},
    {"LDD A, (HL)", 0, FALSE},
    ...
    {"RET NZ", 0, FALSE},
    {"POP BC", 0, FALSE},
    {"JP NZ, 0x%04X", 2, FALSE},
    {"JP 0x%04X", 2, FALSE},
    {"CALL NZ, 0x%04X", 2, FALSE},
    {"PUSH BC", 0, FALSE},
    {"ADD 0x%02X", 1, FALSE},
    {"RST 00h", 0, FALSE},
    {"RET Z", 0, FALSE},
    ...
    {"RET NC", 0, FALSE},
    {"POP DE", 0, FALSE},
    {"JP NC, 0x%04X", 2, FALSE},
    {"!error (D3h)", 0, FALSE},
    {"CALL NC, 0x%04X", 2, FALSE},
    {"PUSH DE", 0, FALSE},
    {"SUB 0x%02X", 1, FALSE},
    {"RST 10h", 0, FALSE},
    {"RET C", 0, FALSE},
